...
<div class="responsive-table">
  <table class="weapons-table">
    <tr>
        ...
        <th class="hlstats-main-description left<?= isSorted('weapon',$sort,$sortorder) ?>"><?= headerUrl('weapon', ['weap_sort','weap_sortorder'], 'weapons').t('th.weapons') ?></a></th>
        <th class="hide-1<?= isSorted('modifier',$sort,$sortorder) ?>"><?= headerUrl('modifier', ['weap_sort','weap_sortorder'], 'weapons').t('modifier') ?></a></th>
        ...
        <th class="<?= isSorted('headshots',$sort,$sortorder) ?>"><?= headerUrl('headshots', ['weap_sort','weap_sortorder'], 'weapons').t('th.headshots') ?></a></th>
        ...
        <th class="hide<?= isSorted('hpk',$sort,$sortorder) ?>"><?= headerUrl('hpk', ['weap_sort','weap_sortorder'], 'weapons').t('th.hsk') ?></a></th>
    </tr>
    <?php
...
<div class="responsive-table">
  <table class="statsme-table">
    <tr>
        ...
        <th class="hide-2<?= isSorted('smdamage',$sort,$sortorder) ?>"><?= headerUrl('smdamage', ['sm_sort','sm_sortorder'], 'statsme').t('th.damage') ?></a></th>
        <th class="hide<?= isSorted('smheadshots',$sort,$sortorder) ?>"><?= headerUrl('smheadshots', ['sm_sort','sm_sortorder'], 'statsme').t('th.headshots') ?></a></th>
        <th class="hide<?= isSorted('smkills',$sort,$sortorder) ?>"><?= headerUrl('smkills', ['sm_sort','sm_sortorder'], 'statsme').t('th.kills') ?></a></th>
        <th class="hide-2<?= isSorted('smkdr',$sort,$sortorder) ?>"><?= headerUrl('smkdr', ['sm_sort','sm_sortorder'], 'statsme').t('th.kd') ?></a></th>
        <th class="hide-1<?= isSorted('smaccuracy',$sort,$sortorder) ?>"><?= headerUrl('smaccuracy', ['sm_sort','sm_sortorder'], 'statsme').t('th.accuracy') ?></a></th>
        <th class="hide-2<?= isSorted('smdhr',$sort,$sortorder) ?>"><?= headerUrl('smdhr', ['sm_sort','sm_sortorder'], 'statsme').t('th.damage.hit') ?></a></th>
        <th class="hide-3<?= isSorted('smspk',$sort,$sortorder) ?>"><?= headerUrl('smspk', ['sm_sort','sm_sortorder'], 'statsme').t('th.shots.kills') ?></a></th>
    </tr>
    <?php
