...
(function () {
    ...
    const PARTS_DEFAULT = [
        { key: "head",     marker: [50,  5], label: [85,  6] },
        { key: "chest",    marker: [50, 26], label: [92, 28] },
        { key: "leftarm",  marker: [65, 38], label: [95, 50] },
        { key: "rightarm", marker: [35, 38], label: [ 5, 50] },
        { key: "stomach",  marker: [50, 40], label: [10, 60] },
        { key: "leftleg",  marker: [60, 70], label: [90, 90] },
        { key: "rightleg", marker: [40, 70], label: [10, 90] }
    ];
    ...
    const GAME_PARTS = {
        cs2: [
            ...
            { key: "rightarm", marker: [35, 38], label: [ 5, 50] },
            { key: "stomach",  marker: [50, 40], label: [10, 60] },
            { key: "leftleg",  marker: [55, 70], label: [90, 90] },
            { key: "rightleg", marker: [42, 70], label: [10, 90] }
        ]
    };
    ...
    function pretty(weapon) {
        if (weapon === "total") return t('hitbox.all.weapons');
    ...
    function buildStatsPanel(weapon, data, total, parts) {
        ...
        totalEl.innerHTML = t('hitbox.total.hits') + " <strong>" + fmtInt(total) + "</strong>";
        ...
        parts.forEach(function (p) {
            ...
            li.innerHTML =
                '<span class="bar-label">' + escapeHtml(t('hitbox.' + p.key)) + "</span>" +
                '<div class="bar-track">' +
    ...
    function buildModelPanel(data, total, parts) {
        ...
        parts.forEach(function (p) {
            ...
            marker.title = t('hitbox.' + p.key) + ": " + fmtInt(v) + " " + t('hitbox.hits') + " (" + pct.toFixed(1) + "%)";
