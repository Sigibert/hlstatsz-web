...
?>
  <table class="players-table">
    <tr>
        ...
        <th class="nowrap hide<?= isSorted('percent',$sort,$sortorder) ?>"><?= headerUrl('percent', ['teams_sort','teams_sortorder'], 'teams').t('th.ratio') ?></a></th>
    </tr>
    <?php
...
<div class="responsive-table">
  <table class="players-table">
    <tr>
        ...
        <th class="hlstats-main-description left<?= isSorted('name',$sort,$sortorder) ?>"><?= headerUrl('name', ['roles_sort','roles_sortorder'], 'roles').t('th.roles') ?></a></th>
        <th class="<?= isSorted('rolecount',$sort,$sortorder) ?>"><?= headerUrl('rolecount', ['roles_sort','roles_sortorder'], 'roles').t('th.joined') ?></a></th>
        <th class="meter-ratio nowarp hide-2<?= isSorted('percent',$sort,$sortorder) ?>"><?= headerUrl('percent', ['roles_sort','roles_sortorder'], 'roles').t('th.ratio') ?></a></th>
        <th class="<?= isSorted('killsTotal',$sort,$sortorder) ?>"><?= headerUrl('killsTotal', ['roles_sort','roles_sortorder'], 'roles').t('th.kills') ?></a></th>
        <th class="hide<?= isSorted('deathsTotal',$sort,$sortorder) ?>"><?= headerUrl('deathsTotal', ['roles_sort','roles_sortorder'], 'roles').t('th.deaths') ?></a></th>
        <th class="hide-1<?= isSorted('kpd',$sort,$sortorder) ?>"><?= headerUrl('kpd', ['roles_sort','roles_sortorder'], 'roles').t('th.kd') ?></a></th>
    </tr>
    <?php
        while ($res = $db->fetch_array($result))
        {
            ...
            if ($image) {
                $img = '<span class="hlstats-image"><img src="' . $image['url'] . '" alt="' . $code . '"/></span>';
