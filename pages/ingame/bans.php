...
echo '<div  class="respondive-table">
<table class="players-table">
    <tr>
        ...
        <th class="'. isSorted('ban_date', $sort, $sortorder) .'">'. headerUrl('ban_date',['sort','sortorder'],'players') .'Ban Date</a></th>
    </tr>';
        ...
        while ($res = $db->fetch_array($result))
        {
            ...
            <tr>
                ...
                echo '<a href="?mode=playerinfo&amp;last_event='.$res['last_event'].'&amp;player='.$res['playerId'].'" title=""><span class="hlstats-name">'.htmlspecialchars(html_entity_decode($res['lastName'], ENT_QUOTES | ENT_HTML5, 'UTF-8'), ENT_COMPAT).' </span></a>
                </td>'
               .($g_options['rankingtype'] != 'kills' ? ('<td class="nowrap">'.nf($res['skill']).'</td>'):'').
                ...
                <td class="nowrap">'.str_replace(" ","<br>@",$res['ban_date']).'</td>
            </tr>';
        }
