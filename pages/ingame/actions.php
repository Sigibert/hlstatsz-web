...
<section class="hlstats-section hlstats-card">
  <div class="hlstats-card-foot"><?= t('total.actions.stats', ["{total}" => '<strong>'.nf($totalactions).'</strong>']) ?></div>
</section>
</div>
<div id="actions">
...
<div  class="responsive-table">
  <table class="players-table">
   ...
   <?php
       echo Pagination($numitems, $_GET['obj_page'] ?? 1, 30, 'obj_page', false, 'actions');
