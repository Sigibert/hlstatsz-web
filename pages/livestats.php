...
function printserverstats($server_id, $server)
{
...
<table class="livestats-table-players">
	<thead><tr>
		<th class="right">#</th>
		<th class="hlstats-main-column left responsive"><?= t('player') ?></th>
		<th class="kd"><span class="k right"><?= t('th.kills') ?></span><span class="sep">:</span><span class="d left"><?= t('th.deaths') ?></span></th>
		<th class="hide"><?= t('th.hs') ?></th>
		<th class="hide-1"><?= t('th.hsk') ?></th>
		<th class="hide-1"><?= t('th.acc') ?></th>
		<th class="hide"><?= t('th.lat') ?></th>
		<th class="hide-2"><?= t('th.time') ?></th>
		<th class="hide-2">+/-</th>
		<th class="hide-3"><?= t('th.skill') ?></th>
	</tr></thead>
	<tbody>
...
?>		</td>
		<td class="left responsive"><?php
				if (isset($thisplayer))
				{
					...
					{
						echo '<span class="hlstats-flag"><img src="'.getFlag($thisplayer['cli_flag']).'" alt="'.ucfirst(strtolower($thisplayer['cli_country'])).'" data-tooltip="'.htmlspecialchars(ucfirst(strtolower($thisplayer['cli_country'])), ENT_QUOTES).'" /></span>';
					}
