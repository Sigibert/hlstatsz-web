...
if ( !defined('IN_HLSTATS') ) { die('Do not access this file directly'); }
	...
	if ( count($_POST) > 0 ) {
		...
		$server_rcon    = clean_data($_POST['server_rcon']);
		$game_mod       = clean_data($_POST['game_mod']);
