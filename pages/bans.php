...
<table class="players-table">
    <tr>
        ...
        <th class="hide-2'. isSorted('acc', $sort, $sortorder) .'">'. headerUrl('acc',['sort','sortorder'],'players') .t('th.accuracy').'</a></th>
        <th class="hide'. isSorted('connection_time', $sort, $sortorder) .'">'. headerUrl('connection_time',['sort','sortorder'],'players') .t('th.connection.time').'</a></th>
        <th class="hide'. isSorted('ban_date', $sort, $sortorder) .'">'. headerUrl('ban_date',['sort','sortorder'],'players') .t('th.ban.date').'</a></th>
    </tr>';
