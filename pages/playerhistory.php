...
if (!is_ajax()) {
	...
	printSectionTitle(t('title.event.history',['{name}'=> ucfirst($pl_name)]));
...
<div  class="responsive-table">
  <table class="players-table">
    <tr>
        <th class="left<?= isSorted('eventTime',$sort,$sortorder) ?>"><?= headerUrl('eventTime', ['sort','sortorder'], 'events') .t('th.date') ?></a></th>
        <th class="left<?= isSorted('eventType',$sort,$sortorder) ?>"><?= headerUrl('eventType', ['sort','sortorder'], 'events') .t('th.type') ?></a></th>
        <th class="hlstats-main-description left<?= isSorted('eventDesc',$sort,$sortorder) ?>"><?= headerUrl('eventDesc', ['sort','sortorder'], 'events') .t('th.description') ?></a></th>
        <th class="hide<?= isSorted('serverName',$sort,$sortorder) ?>"><?= headerUrl('serverName', ['sort','sortorder'], 'events') .t('th.server') ?></a></th>
       <th class="hide-2<?= isSorted('map',$sort,$sortorder) ?>"><?= headerUrl('map', ['sort','sortorder'], 'events') .t('th.map') ?></a></th>
    </tr>
    <?php
        $i= 1 + $start;
